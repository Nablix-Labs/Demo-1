...
class RoutingReasonCode(str, Enum):
    ...
    GUIDED_NO_TARGETS = "GUIDED_NO_TARGETS"
    INDEPENDENT_STARTED = "INDEPENDENT_STARTED"
    INDEPENDENT_IN_PROGRESS = "INDEPENDENT_IN_PROGRESS"
    INDEPENDENT_MASTERY = "INDEPENDENT_MASTERY"
    INDEPENDENT_FAILURE = "INDEPENDENT_FAILURE"
    FRESH_RETRY_FAILED = "FRESH_RETRY_FAILED"
    FRESH_RETRY_SUCCEEDED = "FRESH_RETRY_SUCCEEDED"
    FRESH_CONTENT_UNAVAILABLE = "FRESH_CONTENT_UNAVAILABLE"
